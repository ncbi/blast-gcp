...
class BLAST_QUERY implements Serializable {
    ...
    public BLAST_QUERY(String jsonString) {
        ...
        hsp_blob = json.get (hsp_blob);
        evalue = json.getDouble(evalue);
        asn1_blob = json.get (asn1_blob);
    ...
    // Auto-generated by IntelliJ
    public int hashCode() {
        int result = java.util.Objects.hash(super.hashCode(), protocol, RID, db_tag, top_N_prelim, top_N_traceback, query_seq, query_url, program, blast_params, StartTime, oid, max_score, evalue);
