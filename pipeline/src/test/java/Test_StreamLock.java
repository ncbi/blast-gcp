...
public class Test_StreamLock
{
    ...
    private class lockThread extends Thread
    {
        ...
        private void run_with_lock()
        {
            ...
            while ( i < 10 )
            {
                try
                {
                    File f = new File( FILE_TO_PROTECT );
                    ...
                    if ( f_lock != null )
                    {
                        try
                        {
                            String s = String.format( "T[%d].%d = %s\n", id, i, randomString( ll ) );
    ...
    public void test_locking( boolean with_lock, int ll )
    {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        Test_StreamLock obj = new Test_StreamLock();
        obj.test_locking( with_lock, ll );
    }
}
